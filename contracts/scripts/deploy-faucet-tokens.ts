...
const TOKENS = [
  { name: "Ether",            symbol: "ETH",   decimals: 18, pythId: "0xff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace" },
  { name: "Wrapped Ether",    symbol: "WETH",  decimals: 18, pythId: "0xff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace" },
  { name: "USD Coin",         symbol: "USDC",  decimals: 6,  pythId: "0xeaa020c61cc479712813461ce153894a96a6c00b21ed0cfc2798d1f9a9e9c94a" },
  { name: "Tether USD",       symbol: "USDT",  decimals: 6,  pythId: "0x2b89b9dc8fdf9f34709a5b106b472f0f39bb6ca9ce04b0fd7f2e971688e2e53b" },
  { name: "Wrapped Bitcoin",  symbol: "WBTC",  decimals: 8,  pythId: "0xe62df6c8b4a85fe1a67db44dc12de5db330f7ac66b72dc658afedf0f4a415b43" },
...
async function main() {
  ...
  for (const token of deployedTokens) {
    const tokenInfo = TOKENS.find(t => t.symbol === token.symbol)!;
    try {
      const tx = await oracle.setSource(token.address, tokenInfo.pythId, tokenInfo.decimals, DEFAULT_STALE_THRESHOLD);
      await tx.wait();
