...
export function StrategyRebalance({ strategy }: StrategyRebalanceProps) {
  ...
  const handleRebalance = useCallback(async () => {
    ...
    try {
      ...
      const borrowTokenAddress = TOKEN_SYMBOL_MAP[borrowToken]
        ?.address as Address;
      ...
      const hash = await rebalanceWithEncrypt({
        ...
        addCollateralAmount: parseUnits(
      ...
      const message =
        err instanceof Error ? err.message : "Rebalance transaction failed";
      setError(message);
    } finally {
      ...
      <div className="glass p-6 text-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-muted text-sm">
            Connect your wallet to rebalance this position
          </p>
        </div>
      </div>
    );
    ...
    <div className="glass p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            setAddCollateralAmount(e.target.value.replace(/[^0-9.]/g, ""))
          }
          placeholder="0.00"
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          onChange={(e) =>
            setNewBorrowAmount(e.target.value.replace(/[^0-9.]/g, ""))
          }
          placeholder="0.00"
          className="w-full px-4 py-3 bg-card border border-border text-white text-lg placeholder:text-white/20"
          disabled={isLoading}
