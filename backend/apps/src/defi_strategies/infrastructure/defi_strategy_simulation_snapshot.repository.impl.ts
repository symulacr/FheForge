...
import { DefiStrategySimulationSnapshotRow } from "src/shared/infrastructure/database.types";
	...
	implements DefiStrategySimulationSnapshotRepository
{
	...
	async save(snapshot: DefiStrategySimulationSnapshot): Promise<DefiStrategySimulationSnapshot> {
