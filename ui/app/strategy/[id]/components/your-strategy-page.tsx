...
import { ChevronDown, ChevronUp, Cpu, Play, Plus, Rocket, Target, Trash2 } from "lucide-react";
...
export default function StrategyTable() {
	...
	const [simulateData, setSimulateData] = useState<StrategySimulate | null>(null);
							...
							<tbody className="divide-y divide-white/5">
								{strategies.map((strategy: DefiStrategy) => {
									...
									const tokens = Array.from(
										new Set(steps.flatMap((step) => [step.tokenIn?.symbol, step.tokenOut?.symbol])),
