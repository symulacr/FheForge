  ...
  const pathCards = [
    {
      ...
      tooltip:
        "AI automatically compounds your rewards to maximize returns over time",
      comingSoon: false,
    },
    {
      icon: Droplets,
    ...
    },
    {
      ...
      tooltip:
        "Participate in protocol incentive programs to earn points and rewards",
      comingSoon: true,
    },
    {
      icon: ArrowLeftRight,
      ...
      tooltip:
        "Automatically find and execute profitable trades across different blockchains",
      comingSoon: true,
    },
  ];
        ...
        {!trendingStrategy ? (
          ...
          >
            <Card
              ...
              onClick={() =>
                (window.location.href = `/strategy/${trendingStrategy.id}`)
              }
            >
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex flex-wrap gap-4 pt-3 border-t border-accent/20">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-1.5">
                        {trendingStrategy.chains
                          ?.slice(0, 3)
                          .map((chain: string, idx: number) => (
                            <div
                              key={idx}
                              className="relative w-6 h-6 border border-border overflow-hidden transition-transform bg-white"
                            >
