 ...
 *
 * Tests the BridgeScreenWrapper and BridgeBuilderWorkspace HOCs
 * and screen-specific data wiring.
 * Note: BridgeConnectModal wrapper has been removed from
 * screen-override.js. ConnectInterceptor (connect-interceptor.js)
 * handles ConnectModal at app.jsx level using BridgeBus events.
 */
...
describe('screen-override.js', () => {
  ...
  it('wraps all 6 screen names (ConnectModal excluded — handled by ConnectInterceptor)', () => {
    const screens = [
      'Landing', 'Dashboard', 'Lending', 'Market',
      'Governance', 'BuilderWorkspace',
    ];
...
/* ──────────────────────────────────────────────
   BridgeConnectModal tests have been removed.
   ConnectInterceptor (connect-interceptor.js) replaces
   the BridgeConnectModal wrapper with direct callback
   injection at the app.jsx level using BridgeBus events.
   See connect-interceptor.test.js for step transition tests.
   ────────────────────────────────────────────── */

/* ──────────────────────────────────────────────
   BridgeConnectModal grantPermit, network mismatch,
   onPermitChange, and error handling tests have been removed.
   These behaviors are now covered in connect-interceptor.test.js.
   ────────────────────────────────────────────── */
