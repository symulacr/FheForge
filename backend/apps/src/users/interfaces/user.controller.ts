...
import { toUserResponse, toUserResponseList } from '../application/mappers/user.mapper';
...
export class UserController {
  ...
  getTokenBalance(@Param('address') address: string, @Param('tokenId') tokenId: string): number {
