                          ...
                          {step.tokenIn?.symbol && (
                            <Image
                              src={
                                ...
                                assetIcons[
                                  step.tokenIn.symbol?.toUpperCase()
                                ] ||
                                assetIcons[
                                  step.tokenIn.symbol?.toLowerCase()
                                ] ||
                                "/icons/default.png"
                              }
                          ...
                          {step.tokenOut?.symbol && (
                            <Image
                              src={
                                ...
                                assetIcons[
                                  step.tokenOut.symbol?.toUpperCase()
                                ] ||
                                assetIcons[
                                  step.tokenOut.symbol?.toLowerCase()
                                ] ||
                                "/icons/default.png"
                              }
...
// Default export memoized to prevent unnecessary re-renders when props haven't changed
