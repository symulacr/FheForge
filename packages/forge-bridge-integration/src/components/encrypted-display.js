...
function EncryptedDisplay(_ref) {
	...
	return React.createElement(
		...
		React.createElement("span", { className: "encrypted-content", style: contentStyle }, children),
		showIcon && locked
			? React.createElement(
					"span",
					{ className: "encrypted-indicator", style: indicatorStyle },
					React.createElement(
						"span",
						{
							className: "encrypted-lock-icon",
