		...
		<div className="glass p-6 mb-6">
						...
						<div className="flex items-center gap-2">
							...
							<div className="flex items-center gap-1">
								<div className="w-5 h-5 bg-primary/20 flex items-center justify-center">
									<Image src="/logo-fheforge.svg" alt="fheforge logo" width={20} height={20} />
								</div>
			...
			<div className="flex items-center gap-6">
				<div className="flex items-baseline gap-2">
					...
					<span className="text-3xl font-bold text-success">{(strategy.apy ?? 0).toFixed(2)}%</span>
				</div>
				<div className="flex items-center gap-2 text-sm">
					<span className="text-muted-foreground">
						FheForge is not holding custody over users&apos; assets. Users&apos; funds are under
						their control.
					</span>
				</div>
			</div>
