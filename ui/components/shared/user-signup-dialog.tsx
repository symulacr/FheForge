...
export function UserSignupDialog({
  open,
  onOpenChange,
  onSuccess,
}: UserSignupDialogProps) {
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            This is your first time connecting this wallet. Please sign a
            message to verify ownership and create your account.
          </DialogDescription>
        </DialogHeader>
