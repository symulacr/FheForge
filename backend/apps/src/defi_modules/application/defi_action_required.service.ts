...
export class DefiActionRequiredService {
  constructor(private readonly defiActionRequiredRepository: DefiActionRequiredRepository) {}
  ...
  async getRequiredActionsByActionId(actionId: string) {
    return this.defiActionRequiredRepository.findRequiredActionsByActionId(actionId);
  }
}
